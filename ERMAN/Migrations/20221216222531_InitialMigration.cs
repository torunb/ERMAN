        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsForeignUniversity = table.Column<bool>(type: "boolean", nullable: true),
                    IsElectiveCourse = table.Column<bool>(type: "boolean", nullable: true),
                    IsMustCourse = table.Column<bool>(type: "boolean", nullable: true),
                    CourseType = table.Column<string>(type: "text", nullable: true),
                    CourseCredit = table.Column<float>(type: "real", nullable: true),
                    UniversityId = table.Column<int>(type: "integer", nullable: true),
                    CourseCode = table.Column<string>(type: "text", nullable: true),
                    InstructorMail = table.Column<string>(type: "text", nullable: true),
