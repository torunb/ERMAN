...
namespace ERMAN.Migrations
{
    ...
    [Migration("20221216222531_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERMAN.Common.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("InstructorMail")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ERMAN.Models.University", b =>
                {
                    ...
                    b.Property<int?>("PlacementStudentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ERMAN.Models.CourseMapped", b =>
                {
                    b.HasOne("ERMAN.Common.Course", "BilkentCourse")
                        .WithMany()
            ...
            modelBuilder.Entity("ERMAN.Models.University", b =>
                {
                    b.HasOne("ERMAN.Models.PlacementStudent", null)
                        .WithMany("PreferredUniversity")
            ...
            modelBuilder.Entity("ERMAN.Models.PlacementStudent", b =>
                {
                    b.Navigation("PreferredUniversity");
                });
